...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'web/corn_healing_blade.data';
      var REMOTE_PACKAGE_BASE = 'corn_healing_blade.data';
...
Module['FS_createPath']("/", "res", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_web/corn_healing_blade.data');

      };
      Module['addRunDependency']('datafile_web/corn_healing_blade.data');
    ...
    loadPackage({"files": [{"filename": "/res/test.png", "start": 0, "end": 4964601}], "remote_package_size": 4964601});
...
var wasmBinaryFile;
  wasmBinaryFile = 'corn_healing_blade.wasm';
...
var ASM_CONSTS = {
  91768: () => { if (document.fullscreenElement) return 1; },  
 91814: () => { return document.getElementById('canvas').width; },  
 91866: () => { return parseInt(document.getElementById('canvas').style.width); },  
 91934: () => { document.exitFullscreen(); },  
 91961: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 92034: () => { if (document.fullscreenElement) return 1; },  
 92080: () => { return document.getElementById('canvas').width; },  
 92132: () => { return screen.width; },  
 92157: () => { document.exitFullscreen(); },  
 92184: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 92317: () => { if (document.fullscreenElement) return 1; },  
 92363: () => { return document.getElementById('canvas').width; },  
 92415: () => { return parseInt(document.getElementById('canvas').style.width); },  
 92483: () => { if (document.fullscreenElement) return 1; },  
 92529: () => { return document.getElementById('canvas').width; },  
 92581: () => { return screen.width; },  
 92606: () => { if (document.fullscreenElement) return 1; },  
 92652: () => { return document.getElementById('canvas').width; },  
 92704: () => { return screen.width; },  
 92729: () => { document.exitFullscreen(); },  
 92756: () => { if (document.fullscreenElement) return 1; },  
 92802: () => { return document.getElementById('canvas').width; },  
 92854: () => { return parseInt(document.getElementById('canvas').style.width); },  
 92922: () => { document.exitFullscreen(); },  
 92949: () => { return screen.width; },  
 92974: () => { return screen.height; },  
 93000: () => { return window.screenX; },  
 93027: () => { return window.screenY; },  
 93054: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 93107: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 93178: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 93235: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 93306: () => { if (document.fullscreenElement) return 1; },  
 93352: () => { if (document.pointerLockElement) return 1; }
};
...
var ___start_em_js = Module['___start_em_js'] = 93399;
var ___stop_em_js = Module['___stop_em_js'] = 93472;
